...
class TrainTransformer:
    def __init__(self, args):
        ...
        self.model.load_checkpoint("/root/autodl-tmp/transformer_ckps/transformer_7.pt")
            ...
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    if i%1000 == 0:
                        ...
                        vutils.save_image((sampled_imgs+1)/2, os.path.join("transformer_results_new", f"transformer_{i}.jpg"), nrow=4)
                        #plot_images(log)
                    
            torch.save(self.model.state_dict(), os.path.join("/root/autodl-tmp/transformer_ckps", f"transformer_{epoch+8}.pt"))
...
if __name__ == '__main__':
    ...
    if clear_result:
        try:
            shutil.rmtree('transformer_results')
        except OSError as e:
